...
ActiveRecord::Schema.define(version: 20160621203224) do
  ...
  create_table "platform_resource_capabilities", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["capability_id"],
                name: "index_platform_resource_capabilities_on_capability_id",
                using: :btree
    t.index ["platform_resource_id", "capability_id"],
                                  name: "index_platform_resource_capabilities",
                                  unique: true, using: :btree
    t.index ["platform_resource_id"],
          name: "index_platform_resource_capabilities_on_platform_resource_id",
          using: :btree
  end
  ...
  create_table "sensor_values", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["capability_id"], name: "index_sensor_values_on_capability_id",
                                using: :btree
    t.index ["platform_resource_id"],
            name: "index_sensor_values_on_platform_resource_id", using: :btree
  end
